...
const nextIcon = <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg>
    ...
    const[value,setValue]=useState("");
     ...
     const validEmail = (e) => {
        ...
        if (validator.isEmail(email)) {
          setValue("Thanks. you're on our email list for special offers");
        } else {
          setValue("The email address is invaid");
        }
      };
    return (
        <>
            <div className='PreFooter'>
                <div>
                    ...
                    <p><b>Hassle-free replacement</b>
                        <br /><span>10-day easy replacement policy on mi.com</span></p>
                </div>
                <div>
                    {shieldIcon}
                    <p><b>100% secure payments</b>
                        <br /><span>We support Cards, Wallets, EMI and COD</span></p>
                </div>
                <div>
                    {mapIcon}

                    <p><b>Vast service network</b>
                        <br /><span>1000 Mi service-centers across 600 cities</span> </p>
                </div>
            </div>
            <div className='PreFooter2'>
                <div>
                    <p>LET'S STAY IN TOUCH</p>
                    <span>Get updates on sales specials & more</span>
                </div>
                <div className='input'>
                    <div>
                        <input type='email' name='email'  placeholder='Enter Email Address' onChange={
                            (e)=>validEmail(e)
                        } />
                        <button onClick={validEmail}> {nextIcon} </button><br/>
                        
                    </div>
                    <span style={{display:"inherit"}}>{value}</span>
                </div>
                <div>
                    <p>FOLLOW MI</p>
